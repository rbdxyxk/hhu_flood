...
<script>
  ...
  export default {
    ...
    data() {
      return {
        searchParameter:{
          startDateTime:'2010-08-11 18:00:00',
            //'2013-07-27 08:00:00',
          endDateTime:'2017-09-14 06:00:00',
          options: [{
            value: 41814801,
            label: '石梁河水库'
          }
    ...
    methods:{
      ...
      //关闭选择框打开展示页面
      openRainDataShow:function(data){
        // alert(this.checked_rain_stations);
        this.$emit('openRainDataShow',this.checked_rain_stations,this.rain_stations,data)
      },
      //全选
