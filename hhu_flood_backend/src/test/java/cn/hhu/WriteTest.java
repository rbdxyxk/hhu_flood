...
//                }
    ...
    private <T> T getSingleObject(BaseMapper<T> mapper, int ID){
...
//    @Test
//    public void getCA(){
//        CA_PD ca_pd = ca_pdMapper.selectById(63);
...
//    }
     ...
     * */
    @Deprecated
    private <T> void  lineData(BufferedWriter out, Class<T> clazz,Class cl , int  ID,String name) throws IllegalAccessException, IOException, NoSuchFieldException {
